        ...
        <div  class="media-1 grey-bg">
          ...
          <ul class="row" data-equal="li">
            ...
            <?php
                if($category['image']!='')
                {
                $imagenews=base_url('public/frontend/timthumb/scripts/timthumb.php?src=').base_url('public/uploads/contents/'.$category['image'])."&w=358&h=190&zc=1";	
                }
                else
                {
                $imagenews=base_url('public/frontend/timthumb/scripts/timthumb.php?src=').base_url('public/frontend/images/noimage.jpg')."&w=358&h=190&zc=1";		
                }
                ?>
    ...
    <div class="row">
      <div class="col-md-9 pull-right ">
        <div class="media-2">
          <h2>Photo Gallery</h2>
          <ul class="row" data-equal="li">
            <?php  foreach($albums as $key => $image)  { $defaultimage ='';$defaultimage = @$photos[$image['id']][0]['image']; ?>
            <li class="col-md-6" style="height:155px;" > <a href="<?php echo base_url('public/uploads/gallery/'.$defaultimage); ?>" class="fancybox" rel="gallery<?php echo $key  ?>"><img class="img-responsive" src="<?php echo base_url('public/frontend/timthumb/scripts/timthumb.php?src=').base_url('public/uploads/gallery/'.$defaultimage)."&w=357&h=180&zc=1"; ?>" alt="cmc Photo Gallery" /></a><span><?php echo $image['title']; ?></span> </li>
            <?php   } ?>
          </ul>
          <?php
		  if(count($albums) > 6)
