...
<table width="650" border="0" cellspacing="1" cellpadding="6" bgcolor="#999999" style="font-family:Arial, Helvetica, sans-serif; font-size:12px;">
  ...
  <tr>
    <td colspan="2" bgcolor="#FFFFFF"><strong>A new enquiry has been submitted from <?php echo $this->alphasettings['SITE_NAME']; ?> website: Please login with the below details.</strong></td>
  </tr>
  <!--<tr>
    <td width="96" bgcolor="#E6E6E6"><strong>Full Name</strong></td>
    <td width="527" bgcolor="#FFFFFF"><?php echo $fname; ?></td>
  </tr>-->
<!--  <tr>
...
-->  <!--<tr>
  ...
  <tr>
    <td valign="top" bgcolor="#E6E6E6"><strong>Password</strong></td>
    <td bgcolor="#FFFFFF"><?php echo $passwordcopy; ?> </td>
  </tr>
  <!--<tr>
    <td valign="top" bgcolor="#E6E6E6"><strong>Activation Link</strong></td>
    <td bgcolor="#FFFFFF"><a href="<?php echo site_url('login/activation/'.$key); ?>">Activate</a> </td>
  </tr>-->
  <tr>
