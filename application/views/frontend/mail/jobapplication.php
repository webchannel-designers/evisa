...
<table width="650" border="0" cellspacing="1" cellpadding="6" bgcolor="#999999" style="font-family:Arial, Helvetica, sans-serif; font-size:12px;">
  ...
  <tr>
    <td width="96" bgcolor="#E6E6E6" colspan="2"><strong>Dear <?php echo $firstname; ?>&nbsp;<?php echo $lastname; ?></strong></td>
...
-->  <!--<tr>
  ...
  <tr>
    <td bgcolor="#E6E6E6" colspan="2"><strong>We have received your job application. Our representative will get back to you.</strong></td>
  </tr>
  <tr>
    <td bgcolor="#E6E6E6" colspan="2"><strong>Regards,</strong></td>
  </tr>
  <tr>
