...
<section class="section page-about inner-page">
      <div class="container">
        ...
        <div class="col-md-4">
			...
			<h2>Edit Article</h2>
            <div class="form">
            <?php echo form_open_multipart('login/editblog/'.$content->id.'/'.$this->uri->segment(5).'/'.$return,array("id"=>"myhomeform","class"=>"ajaxform")); ?>
            ...
            <input class="required" name="title" type="text" id="title" value="<?php echo $content->title; ?>" />
            </div>
            <div class="input-holder ">
            ...
            <?php echo $this->ckeditor->editor("desc",html_entity_decode($content->desc)); ?>
            </div>
            <div class="input-holder ">
            
            <label><?php echo convert_lang('Blog Image',$this->alphalocalization); ?> <?php $err=''; if(form_error('department')){ $err=' err'; echo form_error('department'); } ?> - <?php echo $content->image; ?></label> 
