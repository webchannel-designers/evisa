  ...
  <table>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td><?php echo substr($content['title'],0,100); ?>&nbsp;<a href="<?php echo site_url('admin/gallery/add/'.$content['id']); ?>">Gallery Images</a></td>
        ...
        <td><a href="<?php echo site_url('admin/products/edit/'.$content['id'].'/'.$return); ?>" class="table-icon edit" title="Edit"></a> <a href="<?php echo site_url('admin/products/contentwidgets/'.$content['id'].'/'.$return); ?>" class="table-icon widgets" title="Sort Widgets"></a> <a href="<?php echo site_url('admin/products/delete/'.$content['id'].'/'.$return); ?>" class="table-icon delete" title="Delete" onclick="return confirmBox();"></a></td>
      </tr>
      <?php endforeach; ?>
    </tbody>
  </table>
