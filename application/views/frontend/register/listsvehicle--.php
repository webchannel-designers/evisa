  ...
  <!--<div class="col-md-4 col-sm-4">
	...
	<section class="main-content">
		<div class="container">
			...
			<h2><?php echo convert_lang('Change Password',$this->alphalocalization); ?></h2>
  ...
  <table>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td><?php echo substr($content['title'],0,100); ?>&nbsp;<a href="<?php echo site_url('login/addgal/'.$content['id']); ?>">Gallery Images</a></td>
        ...
        <td><?php if($content['status']=='Y') { echo "Active"; } else { echo "Inactive";} ?></td>
        <!-- <td><?php //echo $activearr[$content['featured']]; ?></td>-->
        <td><a href="<?php echo site_url('login/edit/'.$content['id'].'/'.@$return); ?>" class="table-icon edit" title="Edit">Edit</a>  <a href="<?php echo site_url('login/delete/'.$content['id'].'/'.@$return); ?>" class="table-icon delete" title="Delete" onclick="return confirmBox();">Delete</a></td>
      </tr>
      <?php endforeach; ?>
    </tbody>
  </table>
