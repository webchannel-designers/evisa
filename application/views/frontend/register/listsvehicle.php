		...
		<div class="event-slider list">
          <div class="row">
            ...
            <div class="item col-md-4 col-xs-12">
              <figure><a href="<?php echo site_url('login/eventsview/'.$slug)?>"><img src="<?php echo base_url('public/frontend/timthumb/scripts/timthumb.php?src='); ?><?php echo $imagenews."&w=360&h=180&zc=1"; ?>" alt="" class="img-responsive"/></a></figure>
              <div class="item-detail dark">
                <div class="title"><a href="<?php echo site_url('login/eventsview/'.$slug)?>"><?php echo $category['title']; ?></a></div>
                <div class="content"> 
                  <p><strong>Date : </strong><?php echo $date; ?> - <?php echo $dateend; ?>, <?php echo $year; ?></p>
                  <p><strong>Venue :</strong><?php echo $category['keywords']; ?></p>
                </div>
                <div class="item-footer"><a href="<?php echo site_url('login/eventsview/'.$slug)?>" class="btn red">View Details</a></div>
              </div>
            </div>
