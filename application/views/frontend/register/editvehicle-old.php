...
<li class="mandatory">
    ...
    <div class="input-holder">
			...
			<textarea id="desc" name="desc" type="text" class="textarea<?php echo $err; ?>"><?php echo $content->desc; ?></textarea>
            </div>
    ...
    <div class="input-holder">
        ...
        <li >
			...
			<button type="submit" class="btn btn-submit">Save</button><a class="btn btn-submit cancel" href="<?php echo site_url('login/lists'); ?>">Cancel</a>
