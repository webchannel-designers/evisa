<div class="full_w">
	<div class="h_title">Add New Location</div>	
	<?php echo form_open_multipart('admin/location/add'); ?>
		...
		<div class="element">
			<label for="title">Location (<?php echo $this->languagesarr[$this->session->userdata('admin_language')]?>)<?php if(form_error('title')){ $err=' err'; echo form_error('title'); } else  $err='';  ?></label>
