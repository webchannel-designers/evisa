...
<div class="full_w">
  ...
  <?php echo $this->session->flashdata('message'); ?> <?php echo form_open('admin/clients/actions'); ?>
  <div class="entry">
  ...
  <table>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td><?php echo substr($content['fname'],0,100); ?></td>
        <td><?php echo substr($content['email'],0,100); ?></td>
        <td><?php echo $activearr[$content['is_active']]; ?></td>
        <td><a href="<?php echo site_url('admin/clients/edit/'.$content['id'].'/'.$return); ?>" class="table-icon edit" title="Edit"></a> <a href="<?php echo site_url('admin/clients/delete/'.$content['id'].'/'.$return); ?>" class="table-icon delete" title="Delete" onclick="return confirmBox();"></a></td>
      </tr>
      <?php endforeach; ?>
    </tbody>
  </table>
