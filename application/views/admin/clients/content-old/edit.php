...
<div class="full_w">
	...
	<div class="h_title">Edit Testimonials</div>	
...
<input id="short_desc" name="short_desc" type="text" class="text<?php echo $err; ?>" value="<?php echo $content->short_desc; ?>" />
    ...
    <input type="file" name="image" />
       ...
       <div class="element">
		...
		<div class="entry">
			...
			<button type="submit" class="add">Save</button><a class="button cancel" href="<?php echo site_url('admin/news/lists'); ?>">Cancel</a>
