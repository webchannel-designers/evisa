  ...
  <table>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td><?php echo $contact['name']; ?> - <a href="<?php echo site_url('admin/images/add/'.$contact['id'].'/'.$return); ?>">Images</a></td>
        ...
        <td><a href="<?php echo site_url('admin/gallery/editcategory/'.$contact['id'].'/'.$return); ?>" class="table-icon edit" title="Edit"></a> <a href="<?php echo site_url('admin/gallery/deletecategory/'.$contact['id'].'/'.$return); ?>" class="table-icon delete" title="Delete" onclick="return confirmBox();"></a></td>
