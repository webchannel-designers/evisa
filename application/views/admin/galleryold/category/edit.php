<div class="full_w">
	...
	<?php echo form_open('admin/gallery/editcategory/'.$content->id.'/'.$return); ?>
	...
	<input id="id" name="id" type="hidden" value="<?php echo $content->id; ?>" />		
		...
		<div class="entry">
			...
			<button type="submit" class="add">Save</button><a class="button cancel" href="<?php echo site_url('admin/gallery/categories/'.$return); ?>">Cancel</a>
