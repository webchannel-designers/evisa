<div class="full_w">
  ...
  <?php echo form_open_multipart('admin/galleryold/add/'.$uris); ?>
  <div class="element">
  ...
  <?php echo form_close(); ?> <?php echo form_open_multipart('admin/galleryold/update/'.$uris); ?>
    ...
    <ul class="updateform">
      ...
      <li>
        <div class="container"> <img src="<?php echo base_url()."public/uploads/gallery/".$record['image']; ?>" height="100" width="150" /> <a class="lightbox view" href="<?php echo base_url()."public/uploads/gallery/".$record['image']; ?>"   style="float:right"><img src="<?php echo base_url()."public/admin/images/zoom.png"?>" title="View Image" /></a>
          ...
          <a href="<?php echo base_url()."admin/galleryold/setdefault/N/".$record['id']."/".$uris; ?>" style="float:right"> <img src="<?php echo base_url()."public/admin/images/default.gif"?>" title="Set as Default" /> </a>
          <?php } else {?>
          <a href="<?php echo base_url()."admin/galleryold/setdefault/Y/".$record['id']."/".$uris; ?>" style="float:right"><img src="<?php echo base_url()."public/admin/images/empty.png"?>" title="Remove Default" /> </a> <a href="<?php echo base_url()."admin/galleryold/delete/".$record['id']."/".$uris; ?>" style="float:right" onclick="return confirmBox();"><img src="<?php echo base_url()."public/admin/img/i_delete.png"?>" title="Delete Image" /></a>
          <?php } ?>
        </div>
      </li>
      <?php } ?>
  ...
  <div class="entry" style="margin-top:40px;">
    ...
    <a class="button cancel" href="<?php echo site_url('admin/products/lists'); ?>">Cancel</a> 
