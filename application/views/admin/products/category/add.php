<div class="full_w">
  <div class="h_title">Add New Product Category</div>
  <?php echo form_open_multipart('admin/products/addcategory'); ?>
  <div class="element">
  ...
  <div class="entry">
    ...
    <a class="button cancel" href="<?php echo site_url('admin/products/categories'); ?>">Cancel</a> </div>
