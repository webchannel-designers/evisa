...
<div class="full_w">
  <div class="h_title">Edit Product Category</div>
  <?php echo form_open_multipart('admin/products/editcategory/'.$content->id.'/'.$return); ?>
  ...
  <div class="element">
    <label for="image">Banner Image - <?php echo $content->banner_image; ?></label>
  ...
  <div class="entry">
    ...
    <a class="button cancel" href="<?php echo site_url('admin/products/categories/'.$return); ?>">Cancel</a> </div>
