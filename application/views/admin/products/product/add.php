<div class="full_w">
  ...
  <?php echo form_open_multipart('admin/products/add',array('id'=>"productfrm")); ?>
  ...
  <div class="element">
    ...
    <select name="category_id[]" id="category_id" class="text" onchange="load_make(this.value);showType(this.value);" >
  ...
  <!--<div class="element">
    ...
    <option value="0">Normal Piano</option>
    <option value="1">Rental Piano</option>
...
<?php
	$brand = $this->input->post('make_id') ? $this->input->post('make_id'): array();
?>
    <select name="make_id[]" id="multiple" multiple="" class="text multiple" onchange="load_model(this.value);">
    <option value="">Brand</option>
<?php foreach($makes as $contentcat): ?>

      <option value="<?php echo $contentcat['id']; ?>" <?php if(in_array($contentcat['id'],$brand)) { ?> selected="selected"<?php } ?>><?php echo $contentcat['title']; ?></option>
  ...
  <div class="element">
    ...
    <label for="color">Youtube URL (<?php echo $this->languagesarr[$this->session->userdata('admin_language')]?>)
    ...
    <label for="keys">Number of Keys (<?php echo $this->languagesarr[$this->session->userdata('admin_language')]?>)

      <?php if(form_error('keys')){ $err=' err'; echo form_error('keys'); } else { $err=''; ?>
    ...
    <input id="keys" name="keys" type="text" class="text<?php echo $err; ?>" value="<?php echo set_value('keys'); ?>" />

  </div>-->
  
  <!--<div class="element">

    <label for="length">Length (<?php echo $this->languagesarr[$this->session->userdata('admin_language')]?>)

      <?php if(form_error('length')){ $err=' err'; echo form_error('length'); } else { $err=''; ?>
    ...
    <input id="length" name="length" type="text" class="text<?php echo $err; ?>" value="<?php echo set_value('length'); ?>" />

  </div>-->
  
  <!--<div class="element">

    <label for="width">Width (<?php echo $this->languagesarr[$this->session->userdata('admin_language')]?>)

      <?php if(form_error('width')){ $err=' err'; echo form_error('width'); } else { $err=''; ?>
    ...
    <input id="width" name="width" type="text" class="text<?php echo $err; ?>" value="<?php echo set_value('width'); ?>" />

  </div>-->
  
  <!--<div class="element">

    <label for="weight">Weight (<?php echo $this->languagesarr[$this->session->userdata('admin_language')]?>)

      <?php if(form_error('weight')){ $err=' err'; echo form_error('weight'); } else { $err=''; ?>
    ...
    <input id="weight" name="weight" type="text" class="text<?php echo $err; ?>" value="<?php echo set_value('weight'); ?>" />
  ...
  <div class="element">
    ...
    <label for="specification">Description (Specification) (<?php echo $this->languagesarr[$this->session->userdata('admin_language')]?>)
    ...
    <label for="feat">Description (Work Flow) (<?php echo $this->languagesarr[$this->session->userdata('admin_language')]?>)
  ...
  <div class="element">
    ...
    <label for="attachment">Product PDF (<?php echo $this->languagesarr[$this->session->userdata('admin_language')]?>)</label>
...

{
	...
	//dataString = "make="+va;
	dataString=$('#productfrm').serialize();	 	 
