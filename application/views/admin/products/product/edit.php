...
<div class="full_w">
	...
	<?php echo form_open_multipart('admin/products/edit/'.$content->id.'/'.$return,array('id'=>'productfrm')); ?>
    ...
    <option value="0" <?php if($content->type==0) { ?> selected="selected"<?php } ?>>Normal Piano</option>
    
    <option value="1" <?php if($content->type==1) { ?> selected="selected"<?php } ?>>Rental Piano</option>
...
<?php
	$brand = explode(',',$content->make_id);
    //print_r($brand);
?>
    <select name="make_id[]" multiple="" id="multiple" class="text multiple" onchange="load_model(this.value,'');">
  ...
  <!--<div class="element">
    ...
    <input id="keys" name="keys" type="text" class="text<?php echo $err; ?>" value="<?php echo $content->keys; ?>" />
  ...
  <!--<div class="element">
    ...
    <input id="length" name="length" type="text" class="text<?php echo $err; ?>" value="<?php echo $content->length; ?>" />
  ...
  <!--<div class="element">
    ...
    <input id="width" name="width" type="text" class="text<?php echo $err; ?>" value="<?php echo $content->width; ?>" />
  ...
  <!--<div class="element">
    ...
    <input id="weight" name="weight" type="text" class="text<?php echo $err; ?>" value="<?php echo $content->weight; ?>" />
  ...
  <!--<div class="element">
    ...
    <input id="price" name="price" type="text" class="text<?php echo $err; ?>" value="<?php echo $content->price; ?>" />
        ...
        <div class="element">
			...
			<label for="feat">Description (Work Flow) (<?php echo $this->languagesarr[$this->session->userdata('admin_language')]?>) <?php if(form_error('feat')){ $err=' err'; echo form_error('feat'); } else { $err=''; ?><span> (required)</span><?php } ?></label>
