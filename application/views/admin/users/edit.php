	...
	<input id="id" name="id" type="hidden" value="<?php echo $user->id; ?>" />		
        ...
        <div class="element">
			...
			<?php foreach($locations as $location): ?>
				...
				<option value="<?php echo $location['id']; ?>" <?php if($user->location==$location['id']){ echo 'selected="selected"'; }?>><?php echo $location['title']; ?></option>

			<?php endforeach; ?>

			</select>			<!--<input id="email" name="email" type="text" class="text<?php echo $err; ?>" value="<?php echo $user->email; ?>" />-->
