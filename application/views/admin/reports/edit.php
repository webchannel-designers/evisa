<div class="full_w">
	...
	<div class="h_title">Edit Report</div>	

	<?php echo form_open_multipart('admin/reports/edit/'.$download->id.'/'.$return); ?>
	...
	<input id="id" name="id" type="hidden" value="<?php echo $download->id; ?>" />
		...
		<div class="element">
			...
			<label for="attachment">Attachment (<?php echo $this->languagesarr[$this->session->userdata('admin_language')]?>) - <?php echo $download->attachment; ?></label>
		...
		<div class="entry">
			...
			<button type="submit" class="add">Save</button><a class="button cancel" href="<?php echo site_url('admin/reports/lists'.'/'.$return); ?>">Cancel</a>
