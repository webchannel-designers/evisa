<div class="full_w">
	...
	<div class="h_title">Edit Report Category</div>	

	<?php echo form_open('admin/reports/editcategory/'.$download->id.'/'.$return); ?>
	...
	<input id="id" name="id" type="hidden" value="<?php echo $download->id; ?>" />		
		...
		<div class="entry">
			...
			<button type="submit" class="add">Save</button><a class="button cancel" href="<?php echo site_url('admin/reports/categories/'.$return); ?>">Cancel</a>
