<div class="full_w">
	...
	<div class="h_title">Add New Report Category</div>	

	<?php echo form_open('admin/reports/addcategory'); ?>
		...
		<div class="entry">
			...
			<button type="submit" class="add">Save</button><a class="button cancel" href="<?php echo site_url('admin/reports/categories'); ?>">Cancel</a>
