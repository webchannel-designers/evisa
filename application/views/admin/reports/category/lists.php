...
<div class="full_w">
  ...
  <div class="h_title">Manage Report Category - List</div>

  <?php echo $this->session->flashdata('message'); ?> <?php echo form_open('admin/reports/categoryactions'); ?>
  ...
  <table>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td><a href="<?php echo site_url('admin/reports/editcategory/'.$download['id'].'/'.$return); ?>" class="table-icon edit" title="Edit"></a> <a href="<?php echo site_url('admin/reports/deletecategory/'.$download['id'].'/'.$return); ?>" class="table-icon delete" title="Delete" onclick="return confirmBox();"></a></td>
  ...
  <div class="entry">
    ...
    <a class="button add" href="<?php echo site_url('admin/reports/addcategory'); ?>">Add New Report Category</a> </div>
