  ...
  <table>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td><?php echo substr($content['title'],0,100); ?> <?php if($content['slug']=='certification') { ?>  <a href="<?php echo site_url('admin/gallery/add/'.$content['id'].'/'.$return); ?>" title="Add">Certificates</a><?php } ?></td>
