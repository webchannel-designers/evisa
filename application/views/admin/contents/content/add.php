<div class="full_w">
  ...
  <div class="element" id="doctor" style="display:none;">

    <label for="location">Doctor Name (<?php echo $this->languagesarr[$this->session->userdata('admin_language')]?>)
  ...
  <div class="element">
    ...
    <label for="image2">Image for home page (<?php echo $this->languagesarr[$this->session->userdata('admin_language')]?>)</label>
