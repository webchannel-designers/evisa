...
<div class="full_w">
  ...
  <div class="entry">
    ...
    <div style="float:right;"> Sort :
      ...
      Widget Type :
      <select name="widget_type" style="width:75px; margin-right:5px;">
        <option value="">Select</option>
      ...
      Search :
      <input style="margin-right:5px;width:75px;" type="text" name="keyword" value="<?php echo $this->session->userdata('widget_key'); ?>" />
