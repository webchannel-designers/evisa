<div class="full_w">
	...
	<input id="id" name="id" type="hidden" value="<?php echo $widget->id; ?>" />			
		<div class="element">
			...
			<input id="title" name="title" type="text" class="text<?php echo $err; ?>" value="<?php echo $widget->title; ?>" />
		</div>
		<div class="element">
...
?>
			...
			<?php foreach($widget_types as $key => $val): ?>
				<option value="<?php echo $key; ?>" <?php if($widget->widget_position==$key){echo ' selected="selected"';} ?>><?php echo $val; ?></option>
			<?php endforeach; ?>
			</select>
		</div>	
        ...
        <div class="element">
			...
			<?php foreach($widget_type as $key => $val): ?>
				<option value="<?php echo $key; ?>" <?php if($widget->widget_type==$key){echo ' selected="selected"';} ?>><?php echo $val; ?></option>
			<?php endforeach; ?>
			</select>
		</div>	
...
?>
        ...
        <div class="element">
			...
			?>
				<option value="<?php echo $keys['content_category_id']; ?>"  <?php if($keys['content_category_id']==$widget->content_category_id) { echo "selected=selected";     } ?>><?php echo $keys['name']; ?></option>
			<?php endforeach;  ?>
			</select>
		</div>	
		...
		<div class="element">
			...
			<input type="radio" name="status" value="Y" <?php if($widget->status=='Y'){ echo 'checked="checked"';} ?> /> Enabled <input type="radio" name="status" value="N" <?php if($widget->status=='N'){ echo 'checked="checked"';} ?> /> Disabled
		</div>
		<div class="entry">
