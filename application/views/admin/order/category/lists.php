...
?>
<div class="full_w">
  <div class="h_title">Manage Team Category - List</div>
  <?php echo $this->session->flashdata('message'); ?> <?php echo form_open('admin/team/categoryactions'); ?>
  <div class="entry">
  ...
  <table>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td><a href="<?php echo site_url('admin/team/editcategory/'.$gallery['id'].'/'.$return); ?>" class="table-icon edit" title="Edit"></a> <a href="<?php echo site_url('admin/team/deletecategory/'.$gallery['id'].'/'.$return); ?>" class="table-icon delete" title="Delete" onclick="return confirmBox();"></a></td>
      </tr>
      <?php endforeach; ?>
    </tbody>
  </table>
  ...
  <div class="entry">
    ...
    <div class="sep"></div>
    <a class="button add" href="<?php echo site_url('admin/team/addcategory'); ?>">Add New Team Category</a> </div>
</div>