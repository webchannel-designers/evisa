<div class="full_w">
  <div class="h_title">Edit Team Category</div>
  <?php echo form_open_multipart('admin/team/editcategory/'.$gallery->id.'/'.$return); ?>
  ...
  <div class="entry">
    ...
    <a class="button cancel" href="<?php echo site_url('admin/team/categories/'.$return); ?>">Cancel</a> </div>
  <?php echo form_close(); ?> 
</div>
