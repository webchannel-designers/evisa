<div class="full_w">
	...
	<?php echo form_open('admin/gallery/addcategory'); ?>
		...
		<div class="entry">
			...
			<button type="submit" class="add">Save</button><a class="button cancel" href="<?php echo site_url('admin/gallery/categories'); ?>">Cancel</a>
