<div class="full_w">
  ...
  <div class="h_title">Edit Make</div>

  <?php echo form_open_multipart('admin/makes/edit/'.$gallery->id.'/'.$return); ?>
  ...
  <div class="element">
    ...
    <label for="title">Make (<?php echo $this->languagesarr[$this->session->userdata('admin_language')]?>)
  ...
  <div class="entry">
    ...
    <a class="button cancel" href="<?php echo site_url('admin/makes/lists'.'/'.$return); ?>">Cancel</a> </div>
