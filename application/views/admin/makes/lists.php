...
?>
<div class="full_w">
  <div class="h_title">Manage Makes - List</div>
  <?php echo $this->session->flashdata('message'); ?> <?php echo form_open('admin/makes/actions'); ?>
  <div class="entry">
  ...
  <table>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td><a href="<?php echo site_url('admin/makes/edit/'.$gallery['id'].'/'.$return); ?>" class="table-icon edit" title="Edit"></a> <a href="<?php echo site_url('admin/makes/delete/'.$gallery['id'].'/'.$return); ?>" class="table-icon delete" title="Delete" onclick="return confirmBox();"></a></td>
      </tr>
      <?php endforeach; ?>
    </tbody>
  </table>
  ...
  <div class="entry">
    ...
    <div class="sep"></div>
    <a class="button add" href="<?php echo site_url('admin/makes/add'); ?>">Add New Make</a> </div>
</div>
