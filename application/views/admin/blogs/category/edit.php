<div class="full_w">
	<div class="h_title">Edit Blog Category</div>	
	<?php echo form_open('admin/blogs/editcategory/'.$content->id.'/'.$return); ?>
	<input id="id" name="id" type="hidden" value="<?php echo $content->id; ?>" />		
		...
		<div class="entry">
			<button type="submit" class="add">Save</button><a class="button cancel" href="<?php echo site_url('admin/blogs/categories/'.$return); ?>">Cancel</a>
		</div>
	<?php echo form_close(); ?>
</div>