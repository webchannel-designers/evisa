<div class="full_w">
	<div class="h_title">Add New Blog Category</div>	
	<?php echo form_open('admin/blogs/addcategory'); ?>
		<div class="element">
		...
		<div class="entry">
			<button type="submit" class="add">Save</button><a class="button cancel" href="<?php echo site_url('admin/blogs/categories'); ?>">Cancel</a>
		</div>
	<?php echo form_close(); ?>
</div>