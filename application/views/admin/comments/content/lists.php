...
?>
<div class="full_w">
  <div class="h_title">Manage Comments - List</div>
  <?php echo $this->session->flashdata('message'); ?> <?php echo form_open('admin/comments/actions'); ?>
  <div class="entry">
  ...
  <table>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td><?php echo substr($content['email'],0,100); ?></td>
        <td><?php echo $activearr[$content['is_active']]; ?></td>
        <td><a href="<?php echo site_url('admin/comments/edit/'.$content['id'].'/'.$return); ?>" class="table-icon edit" title="Edit"></a> <a href="<?php echo site_url('admin/comments/delete/'.$content['id'].'/'.$return); ?>" class="table-icon delete" title="Delete" onclick="return confirmBox();"></a></td>
      </tr>
      <?php endforeach; ?>
    </tbody>
  </table>
  ...
  <div class="entry">
    ...
    <div class="sep"></div>
    <!--<a class="button add" href="<?php echo site_url('admin/clients/add'); ?>">Add User</a>--> </div>
</div>