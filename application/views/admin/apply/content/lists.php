...
?>
<div class="full_w">
  <div class="h_title">View Apply - List</div>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td class="align-center"><?php echo ++$i; ?></td>
         <td><?php echo $content['first_name']." ".$content['father_name']; ?></td>
        <td><?php echo substr($content['academic_degree'],0,100); ?></td>
        <td><?php echo $dob = date('d-m-Y', strtotime($content['dob'])); ?></td>
        <td><?php echo $content['pob']; ?></td>
           <td><?php echo $content['gender']; ?></td>
		<td><?php echo $content['mobile']; ?></td>
        <td><?php echo $content['email']; ?></td>
        <td><a href="<?php echo site_url('admin/apply/edit/'.$content['id'].'/'.$return); ?>" class="table-icon edit" title="Edit"></a> <a href="<?php echo site_url('admin/apply/delete/'.$content['id'].'/'.$return); ?>" class="table-icon delete" title="Delete" onclick="return confirmBox();"></a></td>
      </tr>
      <?php endforeach; ?>
    </tbody>
  </table>
