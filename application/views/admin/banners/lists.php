...
<div class="full_w">
  ...
  <div class="h_title">Manage Banners - List</div>
  ...
  <table>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td><a href="<?php echo site_url('admin/banners/edit/'.$banner['id'].'/'.$return); ?>" class="table-icon edit" title="Edit"></a> <a href="<?php echo site_url('admin/banners/delete/'.$banner['id'].'/'.$return); ?>" class="table-icon delete" title="Delete" onclick="return confirmBox();"></a></td>
