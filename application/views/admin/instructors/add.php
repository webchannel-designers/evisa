<div class="full_w">
	<div class="h_title">Add New Instructors</div>	
	<?php echo form_open('admin/instructors/add'); ?>
<input id="utype" name="utype" type="hidden" value="I"/>
		<div class="element">
		...
		<div class="entry">
			<button type="submit" class="add">Save</button><a class="button cancel" href="<?php echo site_url('admin/instructors/lists'); ?>">Cancel</a>
		</div>
	<?php echo form_close(); ?>
</div>