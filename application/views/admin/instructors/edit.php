<div class="full_w">
	<div class="h_title">Edit Instructors</div>	
	<?php echo form_open('admin/instructors/edit/'.$facu->id.'/'.$return); ?>
...
<input id="utype" name="utype" type="hidden" value="F"/>
		...
		<div class="entry">
			<button type="submit" class="add">Save</button><a class="button cancel" href="<?php echo site_url('admin/instructors/lists/'.$return); ?>">Cancel</a>
		</div>
	<?php echo form_close(); ?>
</div>