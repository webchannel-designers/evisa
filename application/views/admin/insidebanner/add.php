<div class="full_w">
	...
	<?php echo form_open_multipart('admin/insidebanner/add'); ?>
		<div class="element">
      ...
      <input type="file" name="images[]"  multiple="multiple"/>-->
		...
		<div class="entry">
			<button type="submit" class="add">Save</button><a class="button cancel" href="<?php echo site_url('admin/insidebanner/lists'); ?>">Cancel</a>
		</div>
	<?php echo form_close(); ?>
</div>