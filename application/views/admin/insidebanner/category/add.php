<div class="full_w">
  <div class="h_title">Add New Banner Category</div>
  <?php echo form_open_multipart('admin/insidebanner/addcategory'); ?>
  <div class="element">
  ...
  <div class="entry">
    ...
    <a class="button cancel" href="<?php echo site_url('admin/insidebanner/categories'); ?>">Cancel</a> </div>
  <?php echo form_close(); ?> 
</div>
