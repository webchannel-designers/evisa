...
?>
<div class="full_w">
  <div class="h_title">Manage Banner Category - List</div>
  <?php echo $this->session->flashdata('message'); ?> <?php echo form_open('admin/insidebanner/categoryactions'); ?>
  <div class="entry">
  ...
  <table>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td><a href="<?php echo site_url('admin/insidebanner/editcategory/'.$gallery['id'].'/'.$return); ?>" class="table-icon edit" title="Edit"></a> <a href="<?php echo site_url('admin/insidebanner/deletecategory/'.$gallery['id'].'/'.$return); ?>" class="table-icon delete" title="Delete" onclick="return confirmBox();"></a></td>
      </tr>
      <?php endforeach; ?>
    </tbody>
  </table>
  ...
  <div class="entry">
    ...
    <div class="sep"></div>
    <a class="button add" href="<?php echo site_url('admin/insidebanner/addcategory'); ?>">Add New Banner Category</a> </div>
</div>