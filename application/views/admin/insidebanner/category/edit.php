<div class="full_w">
  <div class="h_title">Edit Banner Category</div>
  <?php echo form_open_multipart('admin/insidebanner/editcategory/'.$gallery->id.'/'.$return); ?>
...
<textarea name="short_desc" id="short_desc" class="text"><?php echo $gallery->short_desc; ?></textarea>
  ...
  <div class="entry">
    ...
    <a class="button cancel" href="<?php echo site_url('admin/insidebanner/categories/'.$return); ?>">Cancel</a> </div>
  <?php echo form_close(); ?> 
</div>
