<div class="full_w">
  ...
  <?php echo form_open_multipart('admin/insidebanner/edit/'.$gallery->id.'/'.$return); ?>
...
<textarea name="short_desc" id="short_desc" class="text"><?php echo $gallery->short_desc; ?></textarea>
  ...
  <div class="entry">
    ...
    <a class="button cancel" href="<?php echo site_url('admin/insidebanner/lists'.'/'.$return); ?>">Cancel</a> </div>
