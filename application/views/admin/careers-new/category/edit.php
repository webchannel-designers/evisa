<div class="full_w">
  ...
  <div class="h_title">Edit Job Category</div>

  <?php echo form_open_multipart('admin/category/edit/'.$gallery->id.'/'.$return); ?>
  ...
  <div class="element">
    ...
    <label for="title">Job Category (<?php echo $this->languagesarr[$this->session->userdata('admin_language')]?>)
  ...
  <div class="entry">
    ...
    <a class="button cancel" href="<?php echo site_url('admin/category/lists'.'/'.$return); ?>">Cancel</a> </div>
