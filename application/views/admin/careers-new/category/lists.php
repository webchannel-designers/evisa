...
?>
<div class="full_w">
  <div class="h_title">Manage Job Category - List</div>
  <?php echo $this->session->flashdata('message'); ?> <?php echo form_open('admin/category/actions'); ?>
  
<!--<div class="search-wrap" style="float:left;"> Sort :
      ...
      Search :
      <input style="margin-right:5px;width:75px;" type="text" name="keyword" value="<?php echo $this->session->userdata('gallery_key'); ?>" />
  ...
  <table>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td align="center"><?php echo $activearr[$gallery['is_active']]; ?></td>
        <td><a href="<?php echo site_url('admin/category/edit/'.$gallery['id'].'/'.$return); ?>" class="table-icon edit" title="Edit"></a> <a href="<?php echo site_url('admin/category/delete/'.$gallery['id'].'/'.$return); ?>" class="table-icon delete" title="Delete" onclick="return confirmBox();"></a></td>
      </tr>
      <?php endforeach; ?>
    </tbody>
  </table>
  ...
  <div class="entry">
    ...
    <div class="sep"></div>
    <a class="button add" href="<?php echo site_url('admin/category/add'); ?>">Add New Job Category</a> </div>
</div>
