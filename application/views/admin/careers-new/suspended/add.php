<div class="full_w">
	<div class="h_title">Add New Faq Category</div>	
	<?php echo form_open('admin/faqs/addcategory'); ?>
		<div class="element">
		...
		<div class="entry">
			<button type="submit" class="add">Save</button><a class="button cancel" href="<?php echo site_url('admin/faqs/categories'); ?>">Cancel</a>
		</div>
	<?php echo form_close(); ?>
</div>