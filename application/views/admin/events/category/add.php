<div class="full_w">
	<div class="h_title">Add New Events Category</div>	
	<?php echo form_open('admin/events/addcategory'); ?>
		<div class="element">
		...
		<div class="entry">
			<button type="submit" class="add">Save</button><a class="button cancel" href="<?php echo site_url('admin/news/categories'); ?>">Cancel</a>
		</div>
	<?php echo form_close(); ?>
</div>