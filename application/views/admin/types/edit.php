<div class="full_w">
  ...
  <div class="h_title">Edit Supplier Category</div>

  <?php echo form_open_multipart('admin/types/edit/'.$gallery->id.'/'.$return); ?>
  ...
  <!--<div class="element">
    ...
    <select name="category_id" id="category_id" class="text">
      ...
      <option value="<?php echo $category['id']; ?>" <?php if($gallery->category_id==$category['id']){echo ' selected="selected"';} ?>><?php echo $category['name']; ?></option>
  ...
  <div class="element">
    ...
    <label for="title">Supplier Category (<?php echo $this->languagesarr[$this->session->userdata('admin_language')]?>)

      <?php if(form_error('title')){ $err=' err'; echo form_error('title'); } else $err='';  ?>

    </label>

    <input id="title" name="title" type="text" class="text<?php echo $err; ?>" value="<?php echo $gallery->type; ?>" />
  ...
  <div class="entry">
    ...
    <a class="button cancel" href="<?php echo site_url('admin/types/lists'.'/'.$return); ?>">Cancel</a> </div>
