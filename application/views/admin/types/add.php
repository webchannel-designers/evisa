...
<div class="full_w">
	<div class="h_title">Add New Supplier Category</div>	
	<?php echo form_open_multipart('admin/types/add'); ?>
		<!--<div class="element">
		...
		<div class="element">
			<label for="title">Supplier Category (<?php echo $this->languagesarr[$this->session->userdata('admin_language')]?>)<?php if(form_error('title')){ $err=' err'; echo form_error('title'); } else  $err='';  ?></label>
      ...
      <input type="file" name="images[]"  multiple="multiple"/>-->
		...
		<div class="entry">
			<button type="submit" class="add">Save</button><a class="button cancel" href="<?php echo site_url('admin/types/lists'); ?>">Cancel</a>
		</div>
	<?php echo form_close(); ?>
</div>