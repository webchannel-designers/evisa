<div class="full_w">
  <div class="h_title">Add New Promotion Category</div>
  <?php echo form_open_multipart('admin/newsgallery/addcategory'); ?>
  <div class="element">
  ...
  <div class="entry">
    ...
    <a class="button cancel" href="<?php echo site_url('admin/newsgallery/categories'); ?>">Cancel</a> </div>
  <?php echo form_close(); ?> 
</div>
