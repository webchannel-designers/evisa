<div class="full_w">
	<div class="h_title">Add New Promotion</div>	
	<?php echo form_open_multipart('admin/newsgallery/add'); ?>
		<div class="element">
        ...
        <!--<div class="element">
            ...
            <option value="public" selected="selected">Public View</option>
        ...
        <div class="element">
			<label for="short_desc">Short Description (<?php echo $this->languagesarr[$this->session->userdata('admin_language')]?>)<?php if(form_error('short_desc')){ $err=' err'; echo form_error('short_desc'); } else  $err='';  ?></label>
             <?php echo $this->ckeditor->editor("short_desc",html_entity_decode(set_value('short_desc'))); ?>
             <?php
	/**
 * <textarea name="short_desc" id="short_desc" class="text"></textarea>
 */
?>
		</div> 	
        <div class="element">
			<label for="link">Hyper Link (<?php echo $this->languagesarr[$this->session->userdata('admin_language')]?>)<?php if(form_error('link')){ $err=' err'; echo form_error('link'); } else  $err='';  ?></label>
			<input id="link" name="link" type="text" class="text<?php echo $err; ?>" value="<?php echo set_value('link'); ?>" />
		</div>	
		<div class="element">
      ...
      <input type="file" name="images[]"  multiple="multiple"/>-->
		...
		<div class="entry">
			<button type="submit" class="add">Save</button><a class="button cancel" href="<?php echo site_url('admin/newsgallery/lists'); ?>">Cancel</a>
		</div>
	<?php echo form_close(); ?>
</div>