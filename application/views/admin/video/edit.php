<div class="full_w">
  ...
  <div class="element">
    ...
    <input id="video" name="video" type="text" class="text<?php echo $err; ?>" value="<?php echo @$gallery->video; ?>" />
  ...
  <div class="entry">
    ...
    <a class="button cancel" href="<?php echo site_url('admin/video/lists'.'/'.$return); ?>">Cancel</a> </div>
