	...
	<table>
		...
		foreach($menus as $menu): ?>
			<tr>
				...
				<td>
					<a href="<?php echo site_url('admin/menus/edit/'.$menu['id'].'/'.$return); ?>" class="table-icon edit" title="Edit"></a>
					<a href="<?php echo site_url('admin/menus/menuitems/'.$menu['id'].'/'.$return); ?>" class="table-icon menuitems" title="Menuitems"></a>
					<a href="<?php echo site_url('admin/menus/delete/'.$menu['id'].'/'.$return); ?>" class="table-icon delete" title="Delete" onclick="return confirmBox();"></a>
				</td>
			</tr>
		<?php endforeach; ?>			
		</tbody>
