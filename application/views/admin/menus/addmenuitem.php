<div class="full_w">
	...
	<?php echo form_open_multipart('admin/menus/menuitemadd/'.$menudetail->id); ?>
		...
		<div class="element">
			...
			<input type="radio" name="show_subitems" value="Y" <?php echo set_radio('show_subitems', 'Y'); ?> /> Yes <input type="radio" name="show_subitems" value="N" <?php echo set_radio('show_subitems', 'N', TRUE); ?> /> No
