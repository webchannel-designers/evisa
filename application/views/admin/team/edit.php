<div class="full_w">
  ...
  <div class="h_title">Edit Team</div>

  <?php echo form_open_multipart('admin/team/edit/'.$gallery->id.'/'.$return); ?>
  ...
  <div class="entry">
    ...
    <a class="button cancel" href="<?php echo site_url('admin/team/lists'.'/'.$return); ?>">Cancel</a> </div>
