...
<div class="full_w">
  <div class="h_title">Manage Enquiries - List</div>
  ...
  <table>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td align="left"><?php echo $enquiry['enq_name']; ?></td>
        <td align="left"><?php echo $enquiry['enq_email']; ?></td>
        <td align="left"><?php echo $enquiry['enq_products']? ''.$enquiry['enq_products']:''; ?></td>
        <td align="center"><?php echo $activearr[$enquiry['is_active']]; ?></td>
        <td nowrap="nowrap"><a href="<?php echo site_url('admin/enquiry/edit/'.$enquiry['id'].'/'.$return); ?>" class="table-icon edit" title="Edit"></a> <a href="<?php echo site_url('admin/enquiry/delete/'.$enquiry['id'].'/'.$return); ?>" class="table-icon delete" title="Delete" onclick="return confirmBox();"></a></td>
      </tr>
      <?php endforeach; ?>
    </tbody>
  </table>
