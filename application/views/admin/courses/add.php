<div class="full_w">
	<div class="h_title">Add New Courses</div>	
	<?php echo form_open('admin/courses/add'); ?>
		<div class="element">
			<label for="name">Courses Name <?php if(form_error('name')){ $err=' err'; echo form_error('name'); } else { $err=''; ?><span> (required)</span><?php } ?></label>
