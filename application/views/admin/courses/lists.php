...
?>
<div class="full_w">
	<div class="h_title">Manage Courses - List</div>
	<?php echo $this->session->flashdata('message'); ?>
	<?php echo form_open('admin/courses/actions'); ?>
	<div class="entry">
...
-->
		...
		foreach($courses as $language): ?>
			<tr>
				...
				<td>
					<a href="<?php echo site_url('admin/courses/edit/'.$language['id'].'/'.$return); ?>" class="table-icon edit" title="Edit"></a>
					<?php if(count($courses)>1){ ?>
					<a href="<?php echo site_url('admin/courses/delete/'.$language['id'].'/'.$return); ?>" class="table-icon delete" title="Delete" onclick="return confirmBox();"></a>
					<?php } ?>
				</td>
			</tr>
		<?php endforeach; ?>			
	...
	<div class="entry">
		...
		<div class="sep"></div>		
		<a class="button add" href="<?php echo site_url('admin/courses/add'); ?>">Add New Courses</a>
	</div>
</div>
