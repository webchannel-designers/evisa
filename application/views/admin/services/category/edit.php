...
<div class="full_w">
	...
	<input id="id" name="id" type="hidden" value="<?php echo $content->id; ?>" />
		...
		<div class="element">
			...
			<label for="parent_id">Parent Category <?php if(form_error('parent_id')){ $err=' err'; echo form_error('parent_id'); } else { $err=''; ?><span> (required)</span><?php } ?></label>
...
<div class="element">
    ...
    <input type="file" name="pdf" />
		...
		<div class="entry">
			...
			<button type="submit" class="add">Save</button><a class="button cancel" href="<?php echo site_url('admin/services/categories/'.$return); ?>">Cancel</a>
