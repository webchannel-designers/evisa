<div class="full_w">
	...
	<?php echo form_open_multipart('admin/contacts/add'); ?>
        ...
        <div class="element">
			...
			<?php echo $this->ckeditor->editor("address2",html_entity_decode(set_value('address2'))); ?>
		...
		<div class="element">
			...
			<input id="latitude" name="latitude" type="text" class="text<?php echo $err; ?>" value="<?php echo set_value('latitude'); ?>" />
		...
		<div class="element">
			...
			<input id="longitude" name="longitude" type="text" class="text<?php echo $err; ?>" value="<?php echo set_value('longitude'); ?>" />
