...
<div class="full_w">
  ...
  <table>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td><a href="<?php echo site_url('admin/contacts/editcategory/'.$contact['id'].'/'.$return); ?>" class="table-icon edit" title="Edit"></a> <a href="<?php echo site_url('admin/contacts/deletecategory/'.$contact['id'].'/'.$return); ?>" class="table-icon delete" title="Delete" onclick="return confirmBox();"></a></td>
  ...
  <div class="entry">
    ...
    <a class="button add" href="<?php echo site_url('admin/contacts/addcategory'); ?>">Add New Contact Category</a> </div>
