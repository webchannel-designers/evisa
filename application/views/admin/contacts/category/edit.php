<div class="full_w">
	...
	<input id="id" name="id" type="hidden" value="<?php echo $contact->id; ?>" />		
		<div class="element">
			...
			<input id="name" name="name" type="text" class="text<?php echo $err; ?>" value="<?php echo $contact->name; ?>" />
		</div>
		<div class="element">
		...
		<div class="entry">
			<button type="submit" class="add">Save</button><a class="button cancel" href="<?php echo site_url('admin/contacts/categories/'.$return); ?>">Cancel</a>
		</div>
	<?php echo form_close(); ?>
</div>