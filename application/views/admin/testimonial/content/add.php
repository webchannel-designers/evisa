<div class="full_w">
  ...
  <?php echo form_open_multipart('admin/brands/add'); ?>
  ...
  <div class="element">
    ...
    <label for="title">Link (<?php echo $this->languagesarr[$this->session->userdata('admin_language')]?>)
    ...
    <div class="element">
      ...
      <textarea id="short_desc" name="short_desc" type="text" class="textarea"><?php echo set_value('short_desc'); ?></textarea>
    ...
    <?php echo $this->ckeditor->editor("video_desc",html_entity_decode(set_value('video_desc'))); ?> </div>
  ...
  <div class="entry">
    ...
    <a class="button cancel" href="<?php echo site_url('admin/brands/lists'); ?>">Cancel</a> </div>
