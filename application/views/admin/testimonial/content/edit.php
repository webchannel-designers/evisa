...
<div class="full_w">
	...
	<?php echo form_open_multipart('admin/brands/edit/'.$content->id.'/'.$return); ?>
	<input id="id" name="id" type="hidden" value="<?php echo $content->id; ?>" />	
		 <div class="element">
			...
			<select name="category_id[]" id="category_id" class="text multiple" multiple="multiple">
        ...
        <div class="element">
			<label for="title">Link (<?php echo $this->languagesarr[$this->session->userdata('admin_language')]?>)<?php if(form_error('author')){ $err=' err'; echo form_error('author'); } else { $err=''; ?><span> (required)</span><?php } ?></label>
      ...
      <textarea id="short_desc" name="short_desc" type="text" class="textarea"><?php echo $content->short_desc; ?></textarea>
    ...
    <label for="desc">Video </label>

    	<?php echo $this->ckeditor->editor("video_desc",$content->video_desc); ?></div>
         <!--<div class="element">
  ...
  <div class="element">
    ...
    <input type="file" name="image" />
       ...
       <div class="element">
		...
		<div class="entry">
			<button type="submit" class="add">Save</button><a class="button cancel" href="<?php echo site_url('admin/brands/lists'); ?>">Cancel</a>
		</div>
	<?php echo form_close(); ?>
</div>