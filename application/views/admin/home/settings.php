<div class="full_w">
	...
	<?php echo form_open('admin/home/settings/'); ?>
	<?php foreach($settings as $setting): ?>
		<div class="element">
			...
			<input type="radio" name="setting[<?php echo $setting['id']; ?>]" value="Y" <?php if($setting['status']=='Y'){ echo 'checked="checked"';} ?> /> Yes <input type="radio" name="setting[<?php echo $setting['id']; ?>]" value="N" <?php if($setting['status']=='N'){ echo 'checked="checked"';} ?> /> No
