<div class="full_w">
	<div class="h_title">Add New Slot</div>	
	<?php echo form_open_multipart('admin/slot/add'); ?>
		<!--<div class="element">
		...
		<div class="element">
			<label for="title">Slot Name (<?php echo $this->languagesarr[$this->session->userdata('admin_language')]?>)<?php if(form_error('title')){ $err=' err'; echo form_error('title'); } else  $err='';  ?></label>
		...
		<div class="element">
			...
			<input id="rates" name="rates" type="text" class="text<?php echo $err; ?>" value="<?php echo set_value('rates'); ?>" />
		</div>        		
        <!--<div class="element">
      ...
      <input type="file" name="images[]"  multiple="multiple"/>-->
		...
		<div class="entry">
			<button type="submit" class="add">Save</button><a class="button cancel" href="<?php echo site_url('admin/slot/lists'); ?>">Cancel</a>
		</div>
	<?php echo form_close(); ?>
</div>