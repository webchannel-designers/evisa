...
?>
<div class="full_w">
  <div class="h_title">Manage Slots</div>
  <?php echo $this->session->flashdata('message'); ?> <?php echo form_open('admin/slot/actions'); ?>
  <div class="entry">
  ...
  <table>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td><a href="<?php echo site_url('admin/slot/edit/'.$gallery['id'].'/'.$return); ?>" class="table-icon edit" title="Edit"></a> <a href="<?php echo site_url('admin/slot/delete/'.$gallery['id'].'/'.$return); ?>" class="table-icon delete" title="Delete" onclick="return confirmBox();"></a></td>
      </tr>
      <?php endforeach; ?>
    </tbody>
  </table>
  ...
  <div class="entry">
    ...
    <div class="sep"></div>
    <a class="button add" href="<?php echo site_url('admin/slot/add'); ?>">Add New Format</a> </div>
</div>
