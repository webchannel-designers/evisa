<div class="full_w">
  ...
  <div class="h_title">Edit Supplier</div>

  <?php echo form_open_multipart('admin/format/edit/'.$gallery->id.'/'.$return); ?>
  ...
  <div class="element">
    ...
    <label for="title">Supplier Name (<?php echo $this->languagesarr[$this->session->userdata('admin_language')]?>)
  ...
  <div class="element">
    ...
    <label for="link">Link (<?php echo $this->languagesarr[$this->session->userdata('admin_language')]?>)

      <?php if(form_error('link')){ $err=' err'; echo form_error('link'); } else $err='';  ?>

    </label>

    <input id="link" name="link" type="text" class="text<?php echo $err; ?>" value="<?php echo $gallery->url; ?>" />
  ...
  <div class="element">
    ...
    <label for="image">Logo (<?php echo $this->languagesarr[$this->session->userdata('admin_language')]?>) - <?php echo $gallery->image; ?></label>
  ...
  <div class="entry">
    ...
    <a class="button cancel" href="<?php echo site_url('admin/format/lists'.'/'.$return); ?>">Cancel</a> </div>
