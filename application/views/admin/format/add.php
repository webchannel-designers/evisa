<div class="full_w">
	<div class="h_title">Add New Supplier</div>	
	<?php echo form_open_multipart('admin/format/add'); ?>
		<!--<div class="element">
		...
		<div class="element">
			<label for="title">Supplier Name (<?php echo $this->languagesarr[$this->session->userdata('admin_language')]?>)<?php if(form_error('title')){ $err=' err'; echo form_error('title'); } else  $err='';  ?></label>
			<input id="title" name="title" type="text" class="text<?php echo $err; ?>" value="<?php echo set_value('title'); ?>" />
		</div>
        <div class="element">
			<label for="link">Link (<?php echo $this->languagesarr[$this->session->userdata('admin_language')]?>)<?php if(form_error('link')){ $err=' err'; echo form_error('link'); } else  $err='';  ?></label>
        ...
        <div class="element">
			<label for="image">Logo (<?php echo $this->languagesarr[$this->session->userdata('admin_language')]?>)</label>
      ...
      <input type="file" name="images[]"  multiple="multiple"/>-->
		...
		<div class="entry">
			<button type="submit" class="add">Save</button><a class="button cancel" href="<?php echo site_url('admin/format/lists'); ?>">Cancel</a>
		</div>
	<?php echo form_close(); ?>
</div>