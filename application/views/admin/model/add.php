...
<div class="full_w">
	<div class="h_title">Add New Model</div>	
	<?php echo form_open_multipart('admin/model/add'); ?>
		<div class="element">
			<label for="category">Make <?php if(form_error('category_id')){ $err=' err'; echo form_error('category_id'); } else { $err=''; ?><span> (required)</span><?php } ?></label>
		...
		<div class="element">
			<label for="title">Model (<?php echo $this->languagesarr[$this->session->userdata('admin_language')]?>)<?php if(form_error('title')){ $err=' err'; echo form_error('title'); } else  $err='';  ?></label>
      ...
      <input type="file" name="images[]"  multiple="multiple"/>-->
		...
		<div class="entry">
			<button type="submit" class="add">Save</button><a class="button cancel" href="<?php echo site_url('admin/model/lists'); ?>">Cancel</a>
		</div>
	<?php echo form_close(); ?>
</div>