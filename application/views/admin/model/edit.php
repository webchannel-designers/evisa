<div class="full_w">
  ...
  <div class="h_title">Edit Model</div>

  <?php echo form_open_multipart('admin/model/edit/'.$gallery->id.'/'.$return); ?>
  ...
  <div class="element">
    ...
    <select name="category_id" id="category_id" class="text">
      ...
      <option value="<?php echo $category['id']; ?>" <?php if($gallery->make_id==$category['id']){echo ' selected="selected"';} ?>><?php echo $category['title']; ?></option>
  ...
  <div class="element">
    ...
    <label for="title">Model (<?php echo $this->languagesarr[$this->session->userdata('admin_language')]?>)
  ...
  <div class="entry">
    ...
    <a class="button cancel" href="<?php echo site_url('admin/model/lists'.'/'.$return); ?>">Cancel</a> </div>
