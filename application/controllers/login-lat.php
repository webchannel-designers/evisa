...
class Login extends Satpifront_Controller {
...
//	}
	...
	public function register2()
	{
		...
		if ($this->form_validation->run() == FALSE)
		{
			...
			$uniq = uniqid();
			$maindata=array('key'=>$uniq,'fname'=>$this->input->post('fullname'),'email'=>$this->input->post('email'),'city'=>$this->input->post('city'),'phone'=>$this->input->post('mobile'),'passwordcopy'=>$this->input->post('password'),'password'=>md5($this->input->post('password')));
	...
	public function myhome2()
	{
		...
		if ($this->form_validation->run() == FALSE)
		{
			...
			$maindata=array('fname'=>$this->input->post('fullname'),'email'=>$this->input->post('email'),'city'=>$this->input->post('city'),'phone'=>$this->input->post('mobile'));
