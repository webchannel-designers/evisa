...
class Products extends Web_Controller {
	...
	function add()
	{
		...
		if ($this->form_validation->run() == FALSE)
		{
            ...
            $brandid=implode(",",$this->input->post('make_id'));
			$maindata=array('featured'=>$this->input->post('featured'),'status'=>$this->input->post('status'),'category_id'=>$pid,'slug'=>$slug,'widgets'=>$widgets);
			$descdata=array('type'=>$this->input->post('type'),'title'=>$this->input->post('title'),'make_id'=>$brandid,'color'=>$this->input->post('color'),'keys'=>$this->input->post('keys'),'length'=>$this->input->post('length'),'width'=>$this->input->post('width'),'weight'=>$this->input->post('weight'),'price'=>$this->input->post('price'),'short_desc'=>$this->input->post('short_desc'),'meta_desc'=>$this->input->post('meta_desc'),'keywords'=>$this->input->post('keywords'),'desc'=>$this->input->post('overview'),'specification'=>$this->input->post('specification'),'feat'=>$this->input->post('feat'),'banner_text'=>$this->input->post('banner_text'),'pdf'=>$pdf,'banner_image'=>$banner_image,'image'=>$content_image,'youtube'=>$this->input->post('youtube'));
	...
	function load_make($id="")
	{
		
		$add['makes']=$this->makes_model->get_active($id);
	...
	function edit($id,$return)
	{
		...
		if ($this->form_validation->run() == FALSE)
		{
            ...
            $brandid=implode(",",$this->input->post('make_id'));
			$maindata=array('featured'=>$this->input->post('featured'),'status'=>$this->input->post('status'),'category_id'=>$pid,'slug'=>$slug,'widgets'=>$widgets);
			$descdata=array('type'=>$this->input->post('type'),'title'=>$this->input->post('title'),'make_id'=>$brandid,'color'=>$this->input->post('color'),'keys'=>$this->input->post('keys'),'length'=>$this->input->post('length'),'width'=>$this->input->post('width'),'weight'=>$this->input->post('weight'),'price'=>$this->input->post('price'),'short_desc'=>$this->input->post('short_desc'),'meta_desc'=>$this->input->post('meta_desc'),'keywords'=>$this->input->post('keywords'),'desc'=>$this->input->post('overview'),'specification'=>$this->input->post('specification'),'feat'=>$this->input->post('feat'),'banner_text'=>$this->input->post('banner_text'),'youtube'=>$this->input->post('youtube'));
			$config['upload_path'] = 'public/uploads/products';
	...
	function addcategory()
	{
		...
		$content_image=$banner_image='';
			...
			{
				$bimagedata=$this->upload->data();
				$banner_image=$bimagedata['file_name'];
			}
			...
			$descdata=array('name'=>$this->input->post('name'),'short_desc'=>$this->input->post('short_desc'),'desc'=>$this->input->post('desc'),'image'=>$content_image,'banner_image'=>$banner_image,'pdf'=>@$content_pdf,'keywords'=>$this->input->post('keywords'));
	...
	function editcategory($id,$return)
	{
		...
		if ($this->form_validation->run() == FALSE)
		{
			...
			{
				$bimagedata=$this->upload->data();
				$descdata['banner_image']=$bimagedata['file_name'];
			}
			$config['allowed_types'] = 'pdf|doc';
	...
	{
		$ids=$this->input->post('id');
		$loginid=false;$sort_orders=$this->input->post('sort_order');
		if(isset($_POST['enable']) && $this->input->post('enable')=='Enable'){ $status='Y';}
		if(isset($_POST['disable']) && $this->input->post('disable')=='Disable'){ $status='N';}
 		if(isset($_POST['featured']) && $this->input->post('featured')=='Featured'){ $fstatus='Y';}
 		if(isset($_POST['unfeatured']) && $this->input->post('unfeatured')=='UnFeatured'){ $fstatus='N';}
