...
class Careerdevelop extends Web_Controller {
...

	{
		...
		redirect('admin/careerdevelop/lists');		
...

	{
		...
		$config['base_url'] = site_url('admin/careerdevelop/lists/');
...

	{
...

		{
			...
			if($loginid){
				...
				redirect('admin/careerdevelop/lists/'.$return);
...

	{
		...
		redirect('admin/careerdevelop/lists/'.$this->input->post('return'));
