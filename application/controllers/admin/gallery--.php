...
class Gallery extends Web_Controller {
...

	{
		...
		{
			$edit['records']=$this->gallery_model->get_array_cond($product_id);			
...
//			}
			...
			if($insertid){
				...
				redirect('admin/gallery/add/'.$product_id);
...
$product_id = $this->uri->segment(4);
			...
			$insertid=$this->gallery_model->update($maindata,$descdata,$key['id']);
