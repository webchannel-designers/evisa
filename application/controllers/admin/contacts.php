...
class Contacts extends Web_Controller {
...

	{
...

		{
			...
			$descdata=array('location'=>$this->input->post('location'),'address'=>$this->input->post('address'),'address2'=>$this->input->post('address2'),'image'=>$content_image);
...

	{
...

		{
			...
			$descdata=array('location'=>$this->input->post('location'),'address'=>$this->input->post('address'),'address2'=>$this->input->post('address2'));
