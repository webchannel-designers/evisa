...
class Products extends Web_Controller {
...

	{
...

		{
			...
			$descdata=array('type'=>$this->input->post('type_id'),'title'=>$this->input->post('title'),'make_id'=>$this->input->post('make_id'),'model_id'=>$this->input->post('model_id'),'location_id'=>$this->input->post('location_id'),'kilometer'=>$this->input->post('kilometer'),'engine'=>$this->input->post('engine'),'fuel_type'=>$this->input->post('fuel'),'color'=>$this->input->post('color'),'transmission'=>$this->input->post('transmission'),'steering_wheel'=>$this->input->post('steering'),'drive_type'=>$this->input->post('drive'),'condition'=>$this->input->post('condition'),'price'=>$this->input->post('price'),'short_desc'=>$this->input->post('short_desc'),'meta_desc'=>$this->input->post('meta_desc'),'keywords'=>$this->input->post('keywords'),'desc'=>$this->input->post('desc'),'feat'=>$this->input->post('feat'),'banner_text'=>$this->input->post('banner_text'));
