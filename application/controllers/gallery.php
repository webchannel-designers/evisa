...
class Gallery extends Visafront_Controller {
...

	{
		...
		$lists['pagelists']=$this->contents_model->get_catcontents('about-us');
		...
		//$gallerycat=$this->gallerycategory_model->get_row_cond(array('id'=>$id));	
		...
		if($cat->short_desc!=''){$this->desc=$cat->short_desc; }
		...
		$this->breadcrumbarr=array(site_url('/')=>$this->alphasettings['BREADCRUMB_START'],site_url('contents/lists/about-us') =>'About Us',site_url('gallery/view/'.$cat->slug) =>$cat->title);	
