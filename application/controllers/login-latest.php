...
//			}
	...
	public function endorsement2($id="")
	{
		...
		if ($this->form_validation->run() == FALSE)
		{
			...
			$maindata=array('title'=>$this->input->post('title'),'event_date'=>$this->input->post('event_date'),'location'=>$this->input->post('location'),'description'=>$this->input->post('description'),'recurring_event'=>$this->input->post('recurring_event'),'event_type'=>$event,'educational_objective'=>$this->input->post('educational_objective'),'evaluation'=>$this->input->post('evaluation'),'target_audience'=>$this->input->post('target_audience'),'no_attendees'=>$this->input->post('no_attendees'),'draft'=>$this->input->post('draft'),'funding'=>$this->input->post('funding'),'countries'=>$this->input->post('countries'),'cme'=>$this->input->post('cme'),'language'=>$this->input->post('language'),'agenda'=>$this->input->post('agenda'),'translation'=>$this->input->post('translation'),'names_faculty'=>$this->input->post('names_faculty'),'course'=>$this->input->post('course'),'course_approval'=>$this->input->post('course_approval'),'sponsorship'=>$this->input->post('sponsorship'),'another_party'=>$this->input->post('another_party'));
