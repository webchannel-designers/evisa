...
class Jobs_model extends CI_Model {
...

    {
		...
		$this->desc_table_name='jobs_desc';

		$this->primary_key ='id';

		$this->foreign_key='jobs_id';
...

    {
		...
		if($this->session->userdata('career_key')!='' && $this->session->userdata('career_key')!=0){

			$this->db->like($this->session->userdata('career_field'),$this->session->userdata('career_key'),'both');
...

	{
		...
		return array('refno'=>'Ref No.','title'=>'Title','short_desc'=>'Short Description');
