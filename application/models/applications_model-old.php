...
class Applications_model extends CI_Model {
...

    {
		...
		if($this->session->userdata('content_rating_to')!='' && $this->session->userdata('content_rating')!='')
		{
		
		$this->db->where('rating >=',$this->session->userdata('content_rating'));
		$this->db->where('rating <=',$this->session->userdata('content_rating_to'));
		
		}elseif($this->session->userdata('content_rating')!='')
		{
		$this->db->where('rating',$this->session->userdata('content_rating'));
		}
		elseif($this->session->userdata('content_rating_to')!='')
		{
		$this->db->where('rating <',$this->session->userdata('content_rating_to'));
		}
