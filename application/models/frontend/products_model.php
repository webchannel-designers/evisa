...
class Products_model extends CI_Model {
...

    {
		...
		$this->desc_table_name='products_desc';
	...
	function get_array_cond($cond,$cond2="")

	{

 		if(isset($cond['make_id']) && @$cond['make_id'] != '')
        {
//            $this->db->where("FIND_IN_SET('{$cond['make_id']}',make_id) !=", 0);
//            unset($cond['make_id']);            
        }
		...
		$this->db->where_in('category_id',$cond2);
...

    {
		...
		$this->db->join($this->desc_table_name, "$this->desc_table_name.$this->foreign_key = $this->table_name.$this->primary_key");
        $this->db->join('products_category cat', "cat.id =$this->table_name.category_id ",'left');
