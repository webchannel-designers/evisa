...
class Newslettergallery_model extends CI_Model {
    function __construct()
    {
        parent::__construct();
		$this->lang_table_name='languages';
		$this->table_name='newsgallery';
		$this->desc_table_name='newsgallery_desc';
		$this->primary_key ='id';
	...
	function get_row_cond($cond,$return='array')
	{
		$this->db->where($cond);
		$this->db->from($this->table_name);
		$this->db->join($this->desc_table_name, "$this->desc_table_name.$this->foreign_key = $this->table_name.$this->primary_key");
